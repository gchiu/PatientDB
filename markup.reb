...
; text
Text: func [t] [
  append Flat-buf spread :['text t
  ]
]
; declaration <!...>
Decl: func [t] [
  append Flat-buf spread :['decl t
  ]
]
; processing instruction <?...>
Proc: func [t] [
  append Flat-buf spread :['proc t
  ]
]
; comment <!--...-->
...
xml: make object! [
  ...
  !attribute: [
    ...
    [ opt !spaces "="
      ...
      (append buf spread :[as issue! as text! x as text! y])
    | (append buf spread :[as issue! as text! x true])
    ]
  ]
  !tag: ["<"
    [ "/" copy x to ">" skip
